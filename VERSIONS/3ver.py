...
if sys.platform == "win32":
    import ctypes
    # Обновлен ID для версии 1.1.1
    myappid = "zapl.pixeldash.launcher.1.1.1"  
...
CURRENT_VERSION = "1.1.1" # Обновлена версия
...
DROPBOX_ZIP_URL = "https://www.dropbox.com/scl/fi/rqzjemcedof1f0vonvhgz/Pixel-Dash.zip?rlkey=98k1k64lb2tfkv762d2qkwwyz&st=npwbtf2h&dl=1"
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Установка иконки для окна приложения и панели задач
        ...
        # Генерация SVG файлов для кнопок, если их нет
    ...
    def create_svg_icons(self):
        ...
        if not os.path.exists("trash_icon.svg"):
            with open("trash_icon.svg", "w") as f: f.write(trash_svg)
        if not os.path.exists("reboot_icon.svg"):
            with open("reboot_icon.svg", "w") as f: f.write(reboot_svg)
    ...
    def init_ui(self):
        ...
        # -- ДОБАВЛЕННЫЕ КРУГЛЫЕ КНОПКИ SVG С ПОДДЕРЖКОЙ СЕРОГО ЦВЕТА (disabled) --
        ...
        self.btn_delete.setIcon(QIcon("trash_icon.svg"))
        ...
        self.btn_reinstall.setIcon(QIcon("reboot_icon.svg"))
...
if __name__ == "__main__":
    ...
    # Дублируем установку иконки для объекта самого QApplication
    if os.path.exists("icon.ico"):
