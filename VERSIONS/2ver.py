...
if sys.platform == "win32":
    import ctypes
    # Указываем имя исполняемого файла или иконки в ID, чтобы Windows жестко связывала процесс с icon.ico
    myappid = "zapl.pixeldash.launcher.1.1.0"  
...
DROPBOX_ZIP_URL = "https://www.dropbox.com/scl/fi/vrgok19lp7rju4emws1jd/Pixel-Dash.zip?rlkey=0epqb7nissh1qwser0t7907l8&st=xisykm1n&dl=1"
